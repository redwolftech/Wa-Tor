...
<body>
    ...
    <asp:Panel ID="pnlMain" runat="server">
        ...
        <div class="buttonscell">
            <asp:LinkButton ID="lbPlay" CssClass="disbutton" Width="100" runat="server" Text="Play" OnClientClick="doPlay();return false;"></asp:LinkButton>
            <asp:LinkButton ID="lbStop" CssClass="disbutton" Width="100" runat="server" Text="Stop" OnClientClick="doStop();return false;"></asp:LinkButton>
            <asp:LinkButton ID="lbPrev" CssClass="disbutton" Width="100" runat="server" Text="Prev" OnClientClick="doPrev();return false;"></asp:LinkButton>
            <asp:LinkButton ID="lbNext" CssClass="disbutton" Width="100" runat="server" Text="Next" OnClientClick="doNext();return false;"></asp:LinkButton>
        </div>
        ...
        <div class="uploadbtn"><asp:LinkButton ID="lbUploadFile" CssClass="disbutton" Width="200" runat="server" Text="Upload and Process" OnClick="lbUploadFile_Click" OnClientClick="return doUpload();"></asp:LinkButton></div>
    </asp:Panel>
